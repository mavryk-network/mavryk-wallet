...
export const mockSodiumUtil = {
  ...
  crypto_sign_seed_keypair: jest.fn(() => ({
    privateKey: new Uint8Array(
      Buffer.from('444e1f4ab90c304a5ac003d367747aab63815f583ff2330ce159d12c1ecceba1')
    ),
  ...
  crypto_secretbox_open_easy: jest.fn(() => new Uint8Array([109, 111, 99, 107, 32, 115, 101, 99, 114, 101, 116, 98, 111, 120])),
