...
import { DisplayedGroup, TempleAccount, TempleHDAccount, TempleAccountType } from 'lib/temple/types';
...
export const getAllGroups = (hdGroups: Pick<DisplayedGroup, 'id' | 'name'>[], accounts: TempleAccount[]) => {
