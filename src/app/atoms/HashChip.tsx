...
export const HashChip: FC<HashChipProps> = ({
  ...
  <CopyButton
    text={hash}
    type={type}
    className={classNames('font-mono', className, showIcon && 'flex text-sm items-center text-blue-200')}
    {...rest}
  >
    <HashShortView
      hash={hash}
      ...
      trim={trim}
    />
    {showIcon && <CopyIcon className="text-blue-200 fill-current w-4 h-4 min-w-4 min-h-4 ml-1" />}
  </CopyButton>
);
